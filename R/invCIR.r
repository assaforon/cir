...
#' @param parabola logical: should the interpolation between design points follow a parabola (\code{TRUE}) or a straight line (\code{FALSE}, default)?
...
if(delta) { ## new default, delta-method ("local") intervals
	dout[,3:4]=deltaInverse(y=dr,target=target,cir=cir,intfun=intfun,conf=conf,seqDesign=seqDesign,parabola=parabola,...)
} else {
