...
# You could plot the CIs too, but they are very broad and much more similar than the point estimates
# The broadness likely reflects the shallow slope, which itself reflects the monotonicity violations
...
legend('topleft',pch=c(NA,'X',NA,NA),lty=c(1,NA,2,1),col=c(4,1,1,1),legend=c('True Curve','Observations','IR Estimate','CIR Estimate'),bty='n')
