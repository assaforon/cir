...
invDelta=deltaInverse(fwd1, target = (1:4)/10, adaptiveCurve = TRUE)
...
plot(dat, ylim=c(0.05,0.55), 
     las=1, xlim=c(0,7), main="Inverse-Estimation CIs") 
...
lines(invDelta[,1],(1:4)/10,lty=2, lwd=2)
lines(invDelta[,2],(1:4)/10,lty=2, lwd=2)
